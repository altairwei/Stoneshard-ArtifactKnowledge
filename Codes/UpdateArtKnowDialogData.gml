...
for (var j = 0; j < array_length(_npc_dialogs); j++)
{
    ...
    _Specs.askVerrenIdentify_pc = {}
    variable_struct_set(_Specs.askVerrenIdentify_pc, "priority", ["-200"])
...
_Specs.mod_artknow_caravanIdentify_positive = {}
variable_struct_set(_Specs.mod_artknow_caravanIdentify_positive, "hub", true)
_Specs.mod_artknow_caravanIdentify_negative = {}
variable_struct_set(_Specs.mod_artknow_caravanIdentify_negative, "hub", true)
_Specs.instruction_INS_giveIdentified = {}
variable_struct_set(_Specs.instruction_INS_giveIdentified, "action", true)
